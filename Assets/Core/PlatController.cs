...
namespace Cycle
{
    public class PlatController : PlatInstance, IPlatController
    {
        ...
        public override void Initialize()
        {
            ...
            if (isDebug)
            {
                Debug.Log(string.Format("{0}Initialize()", debugName));
            }
        }
        ...
        public void Hide(bool isComplete = false)
        {
            ...
            {
                this.onShowHide(this, new ShowHideArgs(ShowHideEnum.Hide));
            }
        }
        ...
        public void Show(bool isComplete = false)
        {
            ...
            if (this.onShowHide != null)
            {
                this.onShowHide(this, new ShowHideArgs(ShowHideEnum.Show));
            }
        }
